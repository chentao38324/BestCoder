 ...
 * 但不能进入行坐标和列坐标的数位之和大于k的格子。eg.当k为18时，机器人能够进入方格(35,37)，因为3+5+3+7=18.
 * 但它不能进入方格(35,38)，因为3+5+3+8=19.请问该机器人能够达到多少格子？
 *
 * 思路：和66题一样，这个方格也可以看出一个m*n的矩阵。同样在这个矩阵中，除边界上的格子之外其他格子都有四个相邻的格子。
